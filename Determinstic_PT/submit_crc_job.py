...
def submit_job(gen_name, test_run=True):
    ...
    file_name = os.path.join(job_scripts_dir, f"{title}_run_PT_opt_{gen_name}"  + ".sh")
...
if __name__ == "__main__":
    ...
    submit_job(gen_name, test_run=True)